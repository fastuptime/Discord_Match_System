module.exports = {
  ...
  category: "Bot",
  description: "Oynadığınız oyunu profilinize eklersiniz.",
  run: async (client, interaction) => {
    ...
    if(check) return system.replyError(interaction, `${oyun} oyunu zaten favorilerinizde bulunuyor.`);
    user.favorite_games.push({ name: oyun, date: moment().format("DD/MM/YYYY HH:mm:ss") });
    user.save();
    system.replySuccess(interaction, `${oyun} oyunu favorilerinize eklendi.`);
  },
};